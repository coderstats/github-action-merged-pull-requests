...
var require_createRequestBody = __commonJS({
  "node_modules/graphql-request/dist/createRequestBody.js"(exports) {
    ...
    function createRequestBody(query2, variables, operationName) {
      var _a = extract_files_1.extractFiles({ query: query2, variables, operationName }, "", isExtractableFileEnhanced), clone = _a.clone, files = _a.files;
      if (files.size === 0) {
...
var require_dist = __commonJS({
  "node_modules/graphql-request/dist/index.js"(exports) {
    ...
    var post = function(_a) {
      var url = _a.url, query2 = _a.query, variables = _a.variables, operationName = _a.operationName, headers = _a.headers, fetch = _a.fetch, fetchOptions = _a.fetchOptions;
    ...
    var GraphQLClient2 = function() {
      ...
      GraphQLClient3.prototype.rawRequest = function(query2, variables, requestHeaders) {
      ...
      GraphQLClient3.prototype.request = function(document, variables, requestHeaders) {
        return __awaiter(this, void 0, void 0, function() {
          var _a, headers, _b, fetch, _c, method, fetchOptions, url, _d, query2, operationName, data;
          return __generator(this, function(_e) {
            switch (_e.label) {
              case 0:
                ...
                url = this.url;
                _d = resolveRequestDocument(document), query2 = _d.query, operationName = _d.operationName;
      ...
      GraphQLClient3.prototype.batchRequests = function(documents, requestHeaders) {
        return __awaiter(this, void 0, void 0, function() {
    ...
    function makeRequest(_a) {
      var url = _a.url, query2 = _a.query, variables = _a.variables, headers = _a.headers, operationName = _a.operationName, fetch = _a.fetch, _b = _a.method, method = _b === void 0 ? "POST" : _b, fetchOptions = _a.fetchOptions;
      return __awaiter(this, void 0, void 0, function() {
    ...
    function rawRequest(url, query2, variables, requestHeaders) {
      return __awaiter(this, void 0, void 0, function() {
        ...
        return __generator(this, function(_a) {
          ...
          return [2, client.rawRequest(query2, variables, requestHeaders)];
        });
      });
    }
...
// src/query.ts
var query = `query mergedPullRequests {
  viewer {
...
async function run() {
  ...
  const client = new import_graphql_request.GraphQLClient(endpoint, {
    headers: {
      authorization: `Bearer ${token}`
    }
  });
  const data = await client.request(query);
  let repos = /* @__PURE__ */ new Map();
  data.viewer.pullRequests.nodes.forEach((node) => {
...
`;
  ...
  await import_fs.promises.writeFile(output, markdown);
}
/*!
 * mime-db
